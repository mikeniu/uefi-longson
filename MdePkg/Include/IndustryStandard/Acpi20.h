...
#define EFI_ACPI_2_0_COREINTC                       0x10
#define EFI_ACPI_2_0_LIOINTC                        0x11
#define EFI_ACPI_2_0_HTINTC                         0x12
#define EFI_ACPI_2_0_EIOINTC                        0x13
#define EFI_ACPI_2_0_PCHINTC                        0x14
#define EFI_ACPI_2_0_MSINTC                         0x15
#define EFI_ACPI_2_0_LPCINTC                        0x16
...
typedef struct {
  ...
  UINT32  Flags;
  UINT8   Version;
} EFI_ACPI_2_0_COREINTC_STRUCTURE;
...
typedef struct {
  ...
  UINT32  CascadeMap[2];
  UINT8   Version;
} EFI_ACPI_2_0_LIOINTC_STRUCTURE;
...
typedef struct {
  ...
  UINT8   Cascade;
  UINT8   Version;
} EFI_ACPI_2_0_EIOINTC_STRUCTURE;
...
typedef struct {
  ...
  UINT16  GsiBase;
  UINT8   Version;
} EFI_ACPI_2_0_PCHINTC_STRUCTURE;
...
typedef struct {
  ...
  UINT8   Cascade;
  UINT8   Version;
} EFI_ACPI_2_0_LPCINTC_STRUCTURE;
