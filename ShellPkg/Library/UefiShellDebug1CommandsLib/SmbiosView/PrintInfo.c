...
#else
    DisplaySPSCharacteristics (
      ReadUnaligned16((UINT16 *) &(Struct->Type39->PowerSupplyCharacteristics)),
      Option
     );
#endif
  ...
  )
{
  ...
  case 0x40:
    ShellPrintHiiEx(-1,-1,NULL,STRING_TOKEN (STR_SMBIOSVIEW_PRINTINFO_LOONGARCH_FAMILY), gShellDebug1HiiHandle);
    break;

  case 0x41:
    Print (L"LOONGARCH 3A5000\n");
    break;
